...
public class ContenidoSqlBean {
    ...
    public ContenidoSqlBean(){}

    public ContenidoSqlBean(String eidr, String titulo, String url_imagen, String descripcion, Date fecha_estreno,
