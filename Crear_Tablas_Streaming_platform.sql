...
('10.5240/A87B-E087-FA21-D93C-66A4-U','Los Puentes de Madison','Una solitaria ama de casa del Medio Oeste natural de la ciudad de Bari (Italia), casada con un soldado estadounidense destinado en Italia y llegada con él a los Estados Unidos.','https://pics.filmaffinity.com/Los_puentes_de_Madison-998728421-large.jpg',CONVERT(DATE,'1995-01-01'),(select id_genero from dbo.Generos_Contenidos where genero = 'Drama'),(select id_tipo_contenido from dbo.Tipos_Contenidos where tipo = 'Películas'),(select id_pais from dbo.Paises_Contenidos where pais = 'EEUU'),CONVERT(DATE,'2015-01-01'),0),
('10.5240/8212-4AA9-5A03-63AE-638B-W','Gran Torino','Walt Kowalski (Clint Eastwood) es un anciano veterano de la guerra de Corea y trabajador jubilado de la fábrica de Ford, de actitud amargada, quien acaba de enviudar','https://pics.filmaffinity.com/Gran_Torino-221086841-large.jpg',CONVERT(DATE,'2008-01-01'),(select id_genero from dbo.Generos_Contenidos where genero = 'Drama'),(select id_tipo_contenido from dbo.Tipos_Contenidos where tipo = 'Películas'),(select id_pais from dbo.Paises_Contenidos where pais = 'EEUU'),CONVERT(DATE,'2015-01-01'),1)
